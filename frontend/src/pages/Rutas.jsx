...
import ModalCrearPuntos from "../components/ModalCrearPuntos";
  ...
  return (
    <Layout titulo="Gestión de Rutas">
      ...
      {mostrarModalCrearPuntos && (
        <ModalCrearPuntos
          mostrarModalCrearPuntos={mostrarModalCrearPuntos}
          setMostrarModalCrearPuntos={setMostrarModalCrearPuntos}
          puntosRuta={puntosRuta}
          setPuntosRuta={setPuntosRuta}
          rutaSeleccionadaParaPuntos={rutaSeleccionadaParaPuntos}
        />
      )}
